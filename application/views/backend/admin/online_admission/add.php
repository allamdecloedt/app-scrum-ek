...
<form method="POST" class="d-block responsive_media_query"
    action="<?php echo site_url('admin/online_admission/assigned'); ?>">
    ...
    <div class="form-group mb-3">
        <div class="col-md-12">
            ...
            <select name="class_id" id="class_id_on_taking_attendance" class="form-control select2"
                data-bs-toggle="select2" onchange="classWiseSectionOnTakingAttendance(this.value)" required>
    ...
    <div class="form-group row mb-3">
        <div class="col-md-12" id="section_content_2">
            ...
            <select name="section_id" id="section_id_on_taking_attendance" class="form-control select2"
