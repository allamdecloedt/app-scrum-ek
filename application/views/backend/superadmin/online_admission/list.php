        ...
        <tr>
          <td>
            <img class="rounded-circle" width="50"
              src="<?php echo $this->user_model->get_user_image($application['id']); ?>">
          </td>
          ...
          <td>
            <div class="dropdown text-center">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <!-- item-->
                <a href="javascript:;"
                  onclick="rightModal('<?php echo site_url('modal/popup/online_admission/add/' . $student['id']) ?>', '<?php echo get_phrase('assign_class_and_section'); ?>');"
                  class="dropdown-item"><?php echo get_phrase('approved'); ?></a>
                <!-- item -->
                <a href="javascript:;" class="dropdown-item"
                  onclick="confirmModalRedirect('<?php echo site_url('admin/online_admission/delete/' . $application['id']); ?>')"><?php echo get_phrase('delete'); ?></a>
              </div>
            </div>
          </td>
        </tr>
