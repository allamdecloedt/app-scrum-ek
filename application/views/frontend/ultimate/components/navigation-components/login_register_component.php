<div class="login-section nav-link ">
    ...
    <div class="login-dropdown hidden-section display-none">
        ...
        <form class="login-form mt-10" id="login-form" action="<?php echo site_url('login/validate_login_frontend'); ?>"
            ...
            <div class="mb-4 mt-4 login-input">
                <label for="loginEmail" class="login-input-label text-uppercase"><?php echo get_phrase("e-mail") ?><span
            ...
            <div class="mb-3 login-input">
                <label for="loginPassword"
                    class=" login-input-label text-uppercase"><?php echo get_phrase("password") ?><span
                        class="required"> * </span></label>
            ...
            <div class="tab">
                <div class="mb-4 login-input">
                    <label for="registerFirstName"
                        class="login-input-label text-uppercase"><?php echo get_phrase("first name") ?><span
                            class="required"> * </span></label>
                ...
                <div class="mb-4 login-input">
                    <label for="registerLastName"
                        class=" login-input-label text-uppercase"><?php echo get_phrase("last name") ?><span
                            class="required"> * </span></label>
                ...
                <div class="mb-4 login-input">
                    <label for="registerEmail"
                        class=" login-input-label text-uppercase"><?php echo get_phrase("e-mail") ?><span
                            class="required"> * </span></label>
            ...
            <div class="tab">
                ...
                <div class="mb-4 login-input">
                    <label for="register_date_of_birth"
                        class=" login-input-label text-uppercase"><?php echo get_phrase("date of birth") ?><span
                            class="required"> * </span></label>
                ...
                <div class="mb-4 login-input">
                    <label for="register_gender"
                        class=" login-input-label text-uppercase"><?php echo get_phrase("gender") ?><span
                            class="required"> * </span></label>
                ...
                <div class="register-form-section pb-4">
                    ...
                    <div class=" mb-3 pt-2  login-input">
                        <label for="registerRepeatPassword"
                            class="login-input-label text-uppercase"><?php echo get_phrase("repeat password") ?><span
                                class="required"> * </span></label>
                        <input oninput="checkPassword()" type="password" class="form-control shadow-none password"
    ...
    <div class="forget-dropdown hidden-section display-none">
        ...
        <form class="forget-form mt-10" id="forget-form" method="post" enctype="multipart/form-data"
            ...
            <!-- <div class="tab"> -->
            <div class="mb-4 login-input">
                <label for="forgetEmail" class="login-input-label text-uppercase"><?php echo get_phrase("Email") ?><span
                        class="required"> * </span></label>
                <input type="text" class="form-control shadow-none information" id="forgotEmail" name="email" required
                    data-msg="<?php echo get_phrase("required") ?>">
            </div>
            <button type="submit" id="registerSubmit" class="register-button text-uppercase">
