            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control shadow-none" placeholder="First Name" id="inputFirstName">
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control shadow-none" placeholder="Last Name" id="InputLastName">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="mb-3 input-group">
                  ...
                  <input type="email" class="form-control shadow-none" id="InputEmail" placeholder="Email">
              ...
              <div class="col-12 col-md-6">
                <div class="input-group mb-3">
                  ...
                  <input type="tel" class="form-control shadow-none" placeholder="Phone Number" id="InputPhoneNumber"
            ...
            <div class="row">
              <div class="col-12 ">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control shadow-none" id="InputSubject" placeholder="Subject">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <div class="input-group mb-3">
                  ...
                  <textarea type="text" class="form-control shadow-none" id="InputMessage" rows="5" placeholder="Write your message here..."></textarea>
                </div>
              </div>
            </div>
            <div class="row justify-content-center">
              <button type="submit" class="btn btn-secondary col-3 mb-3">Send</button>
            </div>
          </form>
        </div>
      </div>
