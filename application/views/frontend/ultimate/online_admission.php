  ...
  <div class="container">
    ...
    <form>
      <div class="row justify-content-center  pb-10">
        <div class="col-sm-1 text-center text-white"> <input value="1" type="radio" name="formselector"
            onClick="displayForm(this)"></input> Student
        </div>
        <div class="col-sm-1 text-center text-white pt-sm-0 p-3"><input value="2" type="radio" name="formselector"
      ...
      <div class="col-sm-6 mb-6 mt-4">
        <div class="js-form-message">
          ...
          <div class="input-group pt-1">
            ...
            <textarea class="form-control shadow-none" rows="3" name="address" required data-msg="Please enter your address."
