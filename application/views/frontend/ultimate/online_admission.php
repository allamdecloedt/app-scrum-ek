    ...
    <div class="container-fluid g-0 text-white">
      <div class="row justify-content-around ">
        <div class="col-12 col-sm-10">
          <div class="row justify-content-between mb-11">
            <div class="col-6 col-sm-6 d-flex justify-content-start"><button id="studentFormSelector"
                class="btn btn-primary btn-sm text-uppercase active-form"><?php echo get_phrase('student'); ?></button>
              <div id="left-line" class="selector-underline"></div>
              <div class="side-line-left" data-selected="true"></div>
            </div>
            <div class="col-6 col-sm-6 d-flex justify-content-end"><button id="schoolFormSelector"
                class="btn btn-primary btn-sm text-uppercase"><?php echo get_phrase('school'); ?></button>
              <div id="right-line" class="selector-underline underline-right"></div>
              <div class="side-line-right" data-selected="false"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <form action="<?php echo site_url('admission/online_admission/submit/student'); ?>" method="post" id="studentform"
        ...
        <div class="col-sm-4 col-11">
          <div class="js-form-message mb-5">
            ...
            <div class="input-group pt-1">
              ...
              <input type="text" placeholder="<?php echo get_phrase('name'); ?>"
                class="form-control shadow-none rounded-end" name="name" required
          ...
          <div class="js-form-message mb-5">
            ...
            <div class="input-group pt-1">
              ...
              <input type="email" placeholder="<?php echo get_phrase('email'); ?>"
                class="form-control rounded-end shadow-none text-capitalize" name="email" required
      ...
      <div class="row justify-content-center mt-4">
        ...
        <div class="col-11 col-sm-8 col-lg-4   ">
          <div class="js-form-message">
            <div class="mb-3">
              <p class="pb-3 form-label text-white text-end"><?php echo get_phrase('your_photo'); ?> <span
                  class="text-danger">*</span>
              </p>
              <div id="photo-preview" class="">
                <a role="button" class="btn photo-preview-btn disabled">
                  <svg class="m-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <input id="student_image" type="file" class="inputfile" name="student_image" accept="image/*" required>
            </div>
