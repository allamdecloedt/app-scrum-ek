        ...
        <div class="col-10 col-sm-8">
          <div class="row justify-content-between mb-11">
            <div class="col-6 col-sm-6 d-flex justify-content-start"><button id="studentFormSelector"
                data-checked="true" class="btn btn-primary btn-sm text-uppercase active-form">student</button>
              <div id="left-line" class="selector-underline"></div>
            </div>
            <div class="col-6 col-sm-6 d-flex justify-content-end"><button id="schoolFormSelector" data-checked=""
                class="btn btn-primary btn-sm text-uppercase">School</button>
    ...
    <form action="<?php echo site_url('home/online_admission/submit'); ?>" method="post" id="studentform"
        ...
        <div class="photo-modal display-none">
          <div class="modal-content">
            <div class="photo-container">
              ...
              <p class="loading text-uppercase">Loading image...</p>
            </div>
          </div>
        </div>
        ...
        <div class="pdf-modal display-none">
          <div class="modal-content">
            <div id="pdf-container" class="pdf-container">
              ...
              <p class="loading text-uppercase">Loading PDF...</p>
            </div>
          </div>
        </div>
        <div class="col-11 col-sm-8 col-lg-4  ">
            ...
            <div class="mb-3">
              ...
              <div id="pdf-preview" class="pdf-preview">
                <a role="button" class="btn pdf-preview-btn disabled">
                  <svg class="m-1 preview-svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-eye-fill" viewBox="0 0 16 16">
                    <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                    <path
                      d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7" />
      ...
      <div class="text-center">
        <button type="submit" id="submitBtn"
          class="btn btn-wide mb-11 text-uppercase submit-button">Apply</button>
